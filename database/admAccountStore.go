...
import (
	...
	"github.com/UNWomenTeam/base-backend/auth/jwt"
...
var (
	// ErrUniqueLoginConstraint provides error message for already registered email address.
	ErrUniqueLoginConstraint = errors.New("login already registered")
...
func (s *AdmAccountStore) Create(a *pwdless.Account) error {
	...
	if count != 0 {
		return ErrUniqueLoginConstraint
	}
